![Tab - EXPO](https://docs.expo.dev/router/advanced/tabs/)

![Tab - React-Native](https://reactnavigation.org/docs/bottom-tab-navigator/#options)

![Image- RN](https://reactnative.dev/docs/images#static-image-resources)
